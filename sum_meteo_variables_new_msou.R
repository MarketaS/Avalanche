...
# = glm(event ~ SCE_value24 + SCE_value48 + SCE_value72 + SCE_value96 + SCE_value120 + SCE_value144, data = adcast_W, family = 'binomial')
#summary(gt_SCE_W)
...
#summary(gt_SCE_C)
#gt_T = glm(event ~ T_value24 + T_value48 + T_value72 + T_value96 + T_value120 + T_value144, data = adcast, family = 'binomial')
#summary(gt_T)
#gt_SRA1H = glm(event ~ SRA1H_value24 + SRA1H_value48 + SRA1H_value72 + SRA1H_value96 + SRA1H_value120 + + SRA1H_value144, data = adcast, family = 'binomial')
#summary

# selection from all available variables the best predictors
...
}# best predictors for aic right now - dont know how to incorporate significant p value - right now I have mostly 0 p value
