...
for (i in 1:nrow(aval_total_lbou)){
  ...
  start <- aval_total_lbou[i,29] # sloupec
...
g1 <- glm(glm_data_lbou_W $event ~ glm_data_lbou_W $SVH_value + 
            glm_data_lbou_W $Fprum_value24 + glm_data_lbou_W $SSV1H_value + 
            glm_data_lbou_W $SRA1H_value + glm_data_lbou_W $D_value96)
